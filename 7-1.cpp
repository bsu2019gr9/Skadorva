...
int AverageAgeInTeam(Footballer* Team) {
	...
	average_age/=size; return average_age;
}
...
int main() {
	...
	case 1: {
		...
		switch (answer3) {
		case 1: {
			cout << AverageAgeInTeam(Team1); break;
		}
		case 2: {
			cout << oldestFootballerInTeam(Team1); break;
		}
		case 3: {
			cout << youngestFootballerInTeam(Team1); break;
		}
		case 4: {
			cout << findTeamGoalsSum(Team1); break;
		}
		case 5: {
			cout << findTeamAssistsSum(Team1); break;
		}
		default:
			break;
		}
